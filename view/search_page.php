...
<section class="search-form">
    <form action="" method="POST">
        <input type="text" class="box" placeholder="пошук товарів..." name="search_box">
...
<?php
        if(isset($_POST['search_btn'])){
         ...
         $select_products = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%{$search_box}%'") or die('Запит не вдався');
      ...
      <?php
                ...
                echo '<p class="empty">Не знайдено результатів!</p>';
            }
        }else{
            echo '<p class="empty">Пошукайте щось!</p>';
        }
      ?>
   </div>
</section>
